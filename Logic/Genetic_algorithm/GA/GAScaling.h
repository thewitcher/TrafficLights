...
public:
  ...
  GASigmaTruncationScaling(float m=gaDefSigmaTruncationMultiplier)
    {multiplier(m);}
  GASigmaTruncationScaling(const GASigmaTruncationScaling & arg): GAScalingScheme(arg) {copy(arg);}
...
public:
  ...
  GAPowerLawScaling(const GAPowerLawScaling & arg): GAScalingScheme(arg) {copy(arg);}
...
public:
  ...
  GASharing(const GASharing & arg): GAScalingScheme(arg) { N=0; d=(float*)0; copy(arg); }
