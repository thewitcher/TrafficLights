...
public:
  ...
  GASelectionScheme(w) 
    { psum = (float*)0; n = 0; }
  GARouletteWheelSelector(const GARouletteWheelSelector& orig): GASelectionScheme(orig)
...
public:
  ...
  GATournamentSelector(const GATournamentSelector& orig): GARouletteWheelSelector(orig) { copy(orig); }
...
public:
  ...
  GAUniformSelector(const GAUniformSelector& orig): GASelectionScheme(orig) { copy(orig); }
