...
void SimpleJunction::runSubcycle_1()
{
    if( m_subcycle_1 != 0 )
    {
...
void SimpleJunction::runSubcycle_2()
{
    if( m_subcycle_2 != 0 )
    {
        if( m_subcycle_1 != 0 ){
...
void SimpleJunction::runSubcycle_3()
{
    if( m_subcycle_3 != 0 )
    {
        if( m_subcycle_2 != 0 && m_subcycle_1 != 0 ){
            runSingleShotForSubcycle_3_WhenAllTimesAreDiferrentThanZero( m_subcycle_1, m_subcycle_2, m_subcycle_3 );
        }
        else if( m_subcycle_2 != 0 && m_subcycle_1 == 0 ){
